				...
				<ul class="list-item-for-custom-list">
					...
					<div class="assigned-staff-for-this-lead user-avatar"><i class="ico-ciuis-products" style="font-size: 32px"></i></div>
						...
						<div class="col-md-8">
							...
							<div class="col-md-4">
								<span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('gst'); ?></small><br>
  ...
  <md-content layout-padding="">
	<md-content layout-padding>
		...
		<md-input-container class="md-block">
			...
			<input  type="text" ng-model="product.purchase_price" class="form-control" id="amount" placeholder="0.00"/>
		</md-input-container>
		<md-input-container class="md-block">
			<label><?php echo lang('salesprice') ?></label>
			<input  type="text" ng-model="product.sale_price" class="form-control" id="amount" placeholder="0.00"/>
		</md-input-container>
		<!--<md-input-container class="md-block">
			<label><?php echo lang('productcode') ?></label>
			<input  type="hidden" ng-model="product.code" class="form-control" id="productcode" placeholder="<?php echo lang('productcode'); ?>"/>
		</md-input-container>-->
		<md-input-container class="md-block">
			<label><?php echo lang('gst') ?></label>
			<input  type="text" ng-model="product.vat" class="form-control" id="tax" placeholder="<?php echo lang('gst'); ?>"/>
		</md-input-container>
		<!--<md-input-container class="md-block">
