		...
		<div class="ciuis-body-content">
			<div class="col-md-4 login-left">
				<div class="lg-content">
					...
					<a href="http://localhost/nexivo/sales/" class="btn btn-warning p-l-20 p-r-20"><?php echo lang('loginhelpbutton')?></a>
				</div>
			</div>
			<div style="float: right; margin-top: -5%;" class="main-content container-fluid col-md-8">
				<div class="splash-container">
					<div class="panel panel-default">
						<div class="panel-heading"><img src="<?php echo base_url('assets/img/logo-fav.png'); ?>" alt="logo" class="logo-img"><?php echo lang('logintitle')?><span class="splash-description">Please register with your user information.</span>
						</div>
						<div class="panel-body">
							<?php echo form_open('login/authreg') ?>
							<div class="form-group">
								<input id="email" type="text" placeholder="Name" name="staffname" autocomplete="off" class="form-control">
							</div>
							<div class="form-group">
								<input id="email" type="email" placeholder="<?php echo lang('loginemail')?>" name="email" autocomplete="off" class="form-control">
							</div>
							<div class="form-group">
								<input  type="text" placeholder="Phone" name="phone" autocomplete="off" class="form-control">
							</div>
							<!--<div class="form-group">
								<input  type="text"  placeholder="admin" name="department"  readonly autocomplete="off" class="form-control">
							</div>-->

							<div class="form-group">
								<input  type="text" placeholder="Company Name" name="company" autocomplete="off" class="form-control">
							</div>
							<div class="form-group">
								<input id="password" type="hidden" name="password" value="root" placeholder="<?php echo lang('loginpassword')?>" class="form-control">
							</div>
							...
							<div class="form-group login-submit">
								<button type="submit" class="btn btn-ciuis btn-xl">Register</button>
							</div>
