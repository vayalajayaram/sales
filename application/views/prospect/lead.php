		...
		<md-toolbar class="toolbar-white">
		  <div class="md-toolbar-tools">
			<md-button class="md-icon-button" aria-label="Settings" ng-disabled="true">
			  <md-icon><i class="ico-ciuis-projects text-warning"></i></md-icon>
			</md-button>
			...
			<md-button ng-show="ONLYADMIN == 'true' || lead.assigned_id == user.id" ng-if="!lead.dateconverted" ng-click="Convert()" class="md-icon-button" aria-label="Convert">
		  		<md-tooltip md-direction="bottom"><?php echo lang('dealclosed') ?></md-tooltip>
			  	<md-icon><i class="glyphicon glyphicon-gift text-success"></i></md-icon>
			</md-button>
			<md-button ng-show="ONLYADMIN == 'true' || lead.assigned_id == user.id" ng-if="!lead.dateconverted" ng-click="AppointmentConvert()" class="md-icon-button" aria-label="Convert">
		  		<md-tooltip md-direction="bottom"><?php echo lang('appointment') ?></md-tooltip>
			  	<md-icon><i class="glyphicon glyphicon-bookmark text-muted"></i></md-icon>
			</md-button>
			<md-button ng-show="ONLYADMIN == 'true' || lead.assigned_id == user.id" ng-if="!lead.dateconverted" ng-click="notinterested()" class="md-icon-button" aria-label="notinterested">
		  		<md-tooltip md-direction="bottom"><?php echo lang('notinterested') ?></md-tooltip>
			  	<md-icon><i class="glyphicon glyphicon-warning-sign text-muted"></i></md-icon>
			</md-button>
			<md-button ng-show="lead.lost == '1'" class="md-icon-button mark-lost" aria-label="Lost">
		  		<md-tooltip md-direction="bottom"><?php echo lang('metnotinterested') ?></md-tooltip>
			  	<md-icon><i class="ion-sad text-black"></i></md-icon>
			</md-button>
			<md-button ng-show="lead.junk == '1'" class="md-icon-button mark-junk" aria-label="Junk" ng-click="ReminderForms()">
		  		<md-tooltip md-direction="left"><?php echo lang('followuptime') ?></md-tooltip>
			  	<md-icon><i class="ion-sad-outline text-warning"></i></md-icon>
			</md-button>
			<md-button ng-show="lead.notmet== '1'" class="md-icon-button mark-junk" aria-label="Junk">
		  		<md-tooltip md-direction="bottom"><?php echo lang('notmet') ?></md-tooltip>
			  	<md-icon><i class="ion-sad-outline text-danger"></i></md-icon>
			</md-button>			
			...
			<ul role="menu" class="dropdown-menu">
				<li ng-show="lead.lost == 0" ng-click="MarkLeadAs(1)" ><a href="#"><?php echo lang('metnotinterested') ?></a></li>
				<li ng-show="lead.lost == 1" ng-click="MarkLeadAs(2)" ><a href="#"><?php echo lang('unmarkmetnotinterested') ?></a></li>
				<li ng-show="lead.junk == 0" ng-click="MarkLeadAs(3)" ><a href="#"><?php echo lang('metfollowup') ?></a></li>
				<li ng-show="lead.junk == 1" ng-click="MarkLeadAs(4)" ><a href="#"><?php echo lang('unmarkmetfollowup') ?></a></li>
				<li ng-show="lead.notmet == 0" ng-click="MarkLeadAs(5)" ><a href="#"><?php echo lang('notmet') ?></a></li>
				<li ng-show="lead.notmet == 1" ng-click="MarkLeadAs(6)" ><a href="#"><?php echo lang('unmarknotmet') ?></a></li>
				<!--<li ng-show="ONLYADMIN == 'true' || lead.assigned_id == user.id" ng-if="!lead.dateconverted" ng-click="AppointmentConvert()" ><a href="#"><?php echo lang('appointment') ?></a></li>
			    <li ng-show="ONLYADMIN == 'true' || lead.assigned_id == user.id" ng-if="!lead.dateconverted" ng-click="notinterestedfsd()" ><a href="#"><?php echo lang('notinterested') ?></a></li>-->
			</ul>
			</div>
		  </div>
		</md-toolbar>
...
<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ReminderForms">
   <md-toolbar class="md-theme-light" style="background:#262626">
  <div class="md-toolbar-tools">
	<md-button ng-click="close()" class="md-icon-button" aria-label="Close">
		 <i class="ion-android-arrow-forward"></i>
	</md-button>
	<md-truncate><?php echo lang('followaddreminder') ?></md-truncate>
  </div>
  </md-toolbar>
...
<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ReminderForm">
  ...
  <md-content layout-padding="">
	<md-content layout-padding>
		...
		<section layout="row" layout-sm="column" layout-wrap class="pull-right">
		  <md-button ng-click="AddFollowReminder()" class="md-raised md-primary"><?php echo lang('add');?></md-button>
		</section>
	</md-content>
 </md-content>
</md-sidenav>
