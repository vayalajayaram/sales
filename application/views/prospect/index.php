		...
		<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-12 md-p-0 lead-table">
			<md-toolbar class="toolbar-trans">
			  <div class="md-toolbar-tools">
				<h2 flex md-truncate class="text-bold"><?php echo lang('Prospects'); ?><br><small flex md-truncate><?php echo lang('prospectdesc'); ?></small></h2>
			...
			<md-content layout-padding class="md-pt-0">
				<ul class="custom-ciuis-list-body" style="padding: 0px;">
					<li ng-repeat="prospect in prospects | filter: FilteredData | filter:search | pagination : currentPage*itemsPerPage | limitTo: 5" class="ciuis-custom-list-item ciuis-special-list-item">
						<ul class="list-item-for-custom-list">
							<li class="ciuis-custom-list-item-item col-md-12">
								<div data-toggle="tooltip" data-placement="bottom" data-container="body" title="" data-original-title="Assigned: {{prospect.assigned}}" class="assigned-staff-for-this-lead user-avatar"><img src="<?php echo base_url('uploads/images/{{prospect.avatar}}')?>" alt="{{lead.assigned}}">
								</div>
								<div class="pull-left col-md-1"><a ng-href="<?php echo base_url('prospect/lead/')?>{{prospect.id}}"><strong ng-bind="prospect.name"></strong></a><!--<br>
								<small ng-bind="prospect.company"></small>-->
								</div>
								<!--<div class="col-md-11">
								    <div class="col-md-3"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('email') ?> <i class="ion-ios-stopwatch-outline"></i></small><br><strong ng-bind="prospect.email"></strong></span>
									</div>
									<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('phone') ?> <i class="ion-ios-stopwatch-outline"></i></small><br><strong ng-bind="prospect.phone"></strong></span>
									</div>
									<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('service') ?> <i class="ion-ios-stopwatch-outline"></i></small><br><strong ng-bind="prospect.title"></strong></span>
									</div>
									<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('assigned') ?> <i class="ion-ios-stopwatch-outline"></i></small><br><strong ng-bind="prospect.assigned"></strong></span>
									</div>
									<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('source') ?> </small><br><strong><span class="badge" style="border-color: #fff;background-color:#ff66ff;" ng-bind="prospect.sourcename"></span></strong></span>
									</div>
									<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('status') ?></small><br><strong><span class="badge" style="border-color: #fff;background-color: {{prospect.color}};" ng-bind="prospect.statusname"></span></strong></span>
									</div>-->

										<div class="col-md-11">
										<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('company') ?></small><br><strong ng-bind="prospect.company"></strong></span>
										</div>
									    <div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('email') ?></small><br><strong ng-bind="prospect.email"></strong></span>
										</div>
										<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('phone') ?> </small><br><strong ng-bind="prospect.phone"></strong></span>
										</div>
										<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('service') ?> </small><br><strong ng-bind="prospect.title"></strong></span>
										</div>
										<!--<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('assigned') ?> </small><br><strong ng-bind="lead.assigned"></strong></span>
										</div>-->
										<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('created') ?> <i class="ion-ios-stopwatch-outline"></i> </small><br><strong ng-bind="prospect.createddate | date:'dd-MM-yyyy'"></strong></span>
										</div>
										<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('source') ?> </small><br><strong><span class="badge" style="border-color: #fff;background-color:#ff66ff;" ng-bind="prospect.sourcename"></span></strong></span>
										</div>
										<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('status') ?></small><br><strong><span class="badge" style="border-color: #fff;background-color: {{prospect.color}};" ng-bind="prospect.statusname"></span></strong></span>
			...
			<md-button aria-label="update Status" class="md-icon-button" ng-click="EditStatus(lead.id)">
				
			<md-tooltip md-direction="bottom"><?php echo lang('updatestatus') ?></md-tooltip>
			<md-icon><i class="ion-bug text-warning"></i></md-icon>
		</md-button> 
		</div>-->
									
		<!--<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('remarks') ?></small><br><strong><center><a ng-href="<?php echo base_url('leads/lead/')?>{{lead.id}}"><button class="btn btn-primary">Add Remarks</button></a></center></strong></span>
									</div>-->
			
				<!--<div class="col-md-1">
					  <span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('edit/update') ?></small></span>
				<md-button ng-show="ONLYADMIN == 'true' || lead.assigned_id == user.id" ng-click="leadStatus()" class="md-icon-button" aria-label="Update">
		  		<md-tooltip md-direction="bottom"><?php echo lang('updatestatus') ?></md-tooltip>
			  	<md-icon><i class="mdi mdi-edit text-danger"></i></md-icon>
			</md-button>
		 
	  </div>-->
	  			<!--<span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('remarks') ?></small></span>-->
				<!--<md-button aria-label="Add Remarks" class="md-icon-button" ng-click="remarks(lead.id)">
				
			<md-tooltip md-direction="bottom"><?php echo lang('addremarks') ?></md-tooltip>
			<md-icon><i class="ion-log-in text-success"></i></md-icon>
		</md-button>-->
			  <!--<span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('edit/update') ?></small></span>-->
	
<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('edit/update') ?></small><br><strong><center><a ng-href="<?php echo base_url('prospect/lead/')?>{{prospect.id}}"><i class="glyphicon glyphicon-edit"></i></a></center></strong></span>
				</div>
	...
	<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Updatee">
  <md-toolbar class="toolbar-white">
  <div class="md-toolbar-tools">
	<md-button ng-click="close()" class="md-icon-button" aria-label="Close">
		 <i class="ion-android-arrow-forward"></i>
