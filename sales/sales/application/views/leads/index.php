...
<div class="ciuis-body-content" ng-controller="Leads_Controller">
	<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-12">
					...
					<li ng-repeat="lead in leads | filter: FilteredData | filter:search | pagination : currentPage*itemsPerPage | limitTo: 5" class="ciuis-custom-list-item ciuis-special-list-item">
						<ul class="list-item-for-custom-list">
							<li class="ciuis-custom-list-item-item col-md-12">
								...
								<div class="col-md-11">
								    <div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('email') ?> <i class="ion-ios-stopwatch-outline"></i></small><br><strong ng-bind="lead.email"></strong></span>
									</div>
									<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('phone') ?> <i class="ion-ios-stopwatch-outline"></i></small><br><strong ng-bind="lead.phone"></strong></span>
									</div>
									<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('service') ?> <i class="ion-ios-stopwatch-outline"></i></small><br><strong ng-bind="lead.title"></strong></span>
									</div>
									<div class="col-md-2"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('assigned') ?> <i class="ion-ios-stopwatch-outline"></i></small><br><strong ng-bind="lead.assigned"></strong></span>
									</div>
									<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('source') ?> </small><br><strong><span class="badge" style="border-color: #fff;background-color:#ff66ff;" ng-bind="lead.sourcename"></span></strong></span>
									</div>
									<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('status') ?></small><br><strong><span class="badge" style="border-color: #fff;background-color: {{lead.color}};" ng-bind="lead.statusname"></span></strong></span>
									</div>
		...
		<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('edit/update') ?></small><br><strong><center><a ng-href="<?php echo base_url('leads/lead/')?>{{lead.id}}"><i class="glyphicon glyphicon-edit"></i></a></center></strong></span>
				</div>
