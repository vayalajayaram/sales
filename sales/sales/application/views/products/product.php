	...
	<div layout="row">
		<md-content class="bg-white" flex="50" style="border-right:1px solid #e0e0e0;">
			...
			<md-list-item>
				...
				<strong flex md-truncate><?php echo lang('gst') ?></strong>
		...
		<div class="col-md-12">
			<div class="ciuis-product-summary">
				<h5 class="text-bold text-uppercase"><?php echo lang('description')?></h5>
				<!--<small><?php echo lang('description') ?></small>-->
				<h1 class="txt-scale-xs no-margin-top xs-28px figures"><span ng-bind="product.description"></span></h1>							
			</div>
		</div>
		<!--<div class="col-md-6">
			<div class="ciuis-product-summary">
