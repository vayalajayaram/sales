			...
			<div class="row">
				<div class="col-md-4">
					<div class="user-display">
						...
						<md-content class="md-padding bg-white">
							<div class="col-xs-4">
								<div class="title"><?php echo lang('leads')?></div>
								<div class="counter"><strong ng-bind="staff.properties.leads_total"></strong></div>
							</div>
							<div class="col-xs-4">
				...
				<md-toolbar class="toolbar-white">
					<div class="md-toolbar-tools">
						...
						<md-button ng-hide="ONLYADMIN != 'false'" ng-click="Updateprofile()" class="md-icon-button" aria-label="Update">
							<md-tooltip md-direction="bottom"><?php echo lang('update') ?></md-tooltip>
							<md-icon><i class="ion-compose	text-muted"></i></md-icon>
						</md-button>
						...
						<md-menu md-position-mode="target-right target" ng-hide="ONLYADMIN != 'true'">
						  ...
						  <md-menu-content width="4">
							...
							<md-menu md-position-mode="target-right target" ng-hide="ONLYADMIN != 'false'">
						  <md-button aria-label="Open demo menu" class="md-icon-button" ng-click="$mdMenu.open($event)">
							<md-icon><i class="ion-android-more-vertical text-muted"></i></md-icon>
						  </md-button>
						  <md-menu-content width="4">
								...
								<div class="widget-counter-group widget-counter-group-right">
									<div class="pull-left md-mb-10">
										<div class="pull-left text-left">
											<h4><b><?php echo lang('staffleadsgraphtitle')?></b></h4>
											<small><?php echo lang('staffleadsgraphdescription')?></small>
										</div>
									</div>
									<div class="counter counter-big">
										<div class="text-warning value" ng-bind="staff.properties.leads_total"></div>
  ...
  <md-content layout-padding="">
	<md-content layout-padding>
		...
		<md-input-container class="md-block">
			...
			<input ng-model="staff.phone" class="form-control" id="title"
...
<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Updateprofile">
  <md-toolbar class="toolbar-white">
  <div class="md-toolbar-tools">
	<md-button ng-click="close()" class="md-icon-button" aria-label="Close">
		 <i class="ion-android-arrow-forward"></i>
