	...
	<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
		<md-toolbar class="toolbar-white">
		  <div class="md-toolbar-tools">
			...
			<md-button ng-show="ONLYADMIN !== 'true' || lead.assigned_id == user.id" ng-click="StatusUpdate()" class="md-icon-button" aria-label="Update">
		  		<md-tooltip md-direction="bottom"><?php echo lang('updatestatus') ?></md-tooltip>
			  	<md-icon><i class="mdi glyphicon glyphicon-ok text-success"></i></md-icon>
			</md-button>
			...
			<md-button ng-show="lead.junk == '1'" class="md-icon-button mark-junk" aria-label="Junk">
		  		<md-tooltip md-direction="bottom"><?php echo lang('metfollowup') ?></md-tooltip>
		...
		<md-tabs md-dynamic-height md-border-bottom>
		  <md-tab label="<?php echo lang('lead') ?>" >
		   ...
		   <md-tab label="<?php echo lang('remarks') ?>" >
			<md-divider></md-divider>
			<md-content class="bg-white" layout-padding>
				<md-list-item>
					<h2 class="text-info" ng-bind="lead.remark_desc"></h2>
				</md-list-item>
			</md-content>
		  </md-tab>
...
<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="StatusUpdate">
  <md-toolbar class="toolbar-white">
  <div class="md-toolbar-tools">
  ...
  <md-content layout-padding="">
	<md-content layout-padding>
		...
		<br>-->
		<md-input-container class="md-block">
			<label><?php echo lang('updatestatus'); ?></label>
		...
		<section layout="row" layout-sm="column" layout-align="center center" layout-wrap>
		  <md-button ng-click="UpdateLeadstatus()" class="md-raised md-primary pull-right"><?php echo lang('update');?></md-button>
		</section>		
	</md-content>
 </md-content>
</md-sidenav>	
  ...
  <md-content layout-padding="">
	<md-content layout-padding>
		<md-input-container class="md-block">
			...
			<!--<input mdc-datetime-picker="" date="true" time="true" seconds="true" format="HH:mm:ss" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" min-date="date" show-icon="true" ng-model="reminder_date" class=" dtp-no-msclear dtp-input md-input">-->
	<input mdc-datetime-picker="" date="true" time="true" seconds="true" type="text"
id="time3" placeholder="<?php echo lang('chooseadate') ?>" minutes="true" auto-ok="true" min-date="minDateNow"
minute-steps="1" format="HH:mm:ss" short-time="false" show-icon="true" ng-model="reminder_date" class=" dtp-no-msclear dtp-input md-input">	
		</md-input-container>
