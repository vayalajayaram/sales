...
<div class="ciuis-body-content" ng-controller="Leads_Controller">
	<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-12">
					...
					<li ng-repeat="lead in leads | filter: FilteredData | filter:search | pagination : currentPage*itemsPerPage | limitTo: 5" class="ciuis-custom-list-item ciuis-special-list-item">
						<ul class="list-item-for-custom-list">
							<li class="ciuis-custom-list-item-item col-md-12">
								...
								<div class="pull-left col-md-1"><a ng-href="<?php echo base_url('leads/lead/')?>{{lead.id}}"><strong ng-bind="lead.name"></strong></a><!--<br>
								<small ng-bind="lead.company"></small>-->
								</div>
									<div class="col-md-11">
										<div class="col-md-2"><span class="date-start-task"><small class="text-success text-uppercase"><?php echo lang('company') ?></small><br><strong ng-bind="lead.company"></strong></span>
										</div>
									    <!--<div class="col-md-3"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('email') ?></small><br><strong ng-bind="lead.email"></strong></span>
										</div>-->
										<div class="col-md-2"><span class="date-start-task"><small class="text-success text-uppercase"><?php echo lang('phone') ?> </small><br><strong ng-bind="lead.phone"></strong></span>
										</div>
										<div class="col-md-2"><span class="date-start-task"><small class="text-success text-uppercase"><?php echo lang('service') ?> </small><br><strong ng-bind="lead.title"></strong></span>
										</div>
										...
										<div class="col-md-2"><span class="date-start-task"><small class="text-success text-uppercase"><?php echo lang('created') ?> <i class="ion-ios-stopwatch-outline"></i> </small><br><strong ng-bind="lead.createddate | date:'dd-MM-yyyy'"></strong></span>
										</div>
										<div class="col-md-1"><span class="date-start-task"><small class="text-success text-uppercase"><?php echo lang('source') ?> </small><br><strong><span class="badge" style="border-color: #fff;background-color:#ff66ff;" ng-bind="lead.sourcename"></span></strong></span>
										</div>
										<div class="col-md-1"><span class="date-start-task"><small class="text-success text-uppercase"><?php echo lang('status') ?></small><br><strong><span class="badge" style="border-color: #fff;background-color: {{lead.color}};" ng-bind="lead.statusname"></span></strong></span>
										</div>
		...
		<!--<div class="col-md-1"><span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang('remarks') ?></small><br><strong><center><a ng-href="<?php echo base_url('leads/lead/')?>{{lead.id}}"><button class="btn btn-primary">Add Remarks</button></a></center></strong></span>
			...
			<md-icon><i class="ion-log-in text-warning"></i></md-icon>
		</md-button>
		<div class="col-md-1"><span class="date-start-task"><small class="text-success text-uppercase"><?php echo lang('edit/update') ?></small><br><strong><center><a ng-href="<?php echo base_url('leads/lead/')?>{{lead.id}}"><i class="glyphicon glyphicon-edit"></i></a></center></strong></span>
				</div>
	...
	<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ContentFilter">
	  ...
	  <md-content layout-padding="">
		<div ng-repeat="(prop, ignoredValue) in leads[0]" ng-init="filter[prop]={}" ng-if="prop != 'name' && prop != 'id' && prop != 'company' && prop != 'phone' && prop != 'color' && prop != 'status' && prop != 'source' && prop != 'assigned' && prop != 'avatar' && prop != 'staff' && prop != 'createddate' && prop != 'statusname' && prop != 'sourcename' && prop != 'email' && prop != 'title'">
