           ...
           <?php foreach($subcategories as $subcat){ ?>
              <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                <div class="footer-widget">
                  <h3><?php echo $subcat['subcategory_name']; ?></h3>
                  <ul class="footer-menu">
                  <?php foreach($subsubcategories as $subsubcat){ 
				  if($subsubcat['subcategory_id']==$subcat['subcategory_id']){
				  ?>
                    <li><a href="<?php echo base_url(); ?>products/<?php echo str_replace(" ","-",$subsubcat['name']); ?>"><?php echo $subsubcat['name']; ?></a></li>
                  <?php  } } ?>           
                  </ul>
                </div>
