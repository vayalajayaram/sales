                    ...
                    <form action="" method="post" class="profiel-container1 clearfix">
                            ...
                            <div class="clear">
                                <div class="col-sm-12 col-md-4 col-xs-12">
                                    <div class="picture-container">
                                        <div class="picture">
                                            <img src="<?php echo base_url().$prof['image']; ?> " class="picture-src img-circle" id="wizardPicturePreview" title="" alt="team">
                                        </div>
                                        <h4><?php echo $prof['first_name']; ?> <?php echo $prof['last_name']; ?></h4>
                                    </div>
                                </div>

                                <div class="col-md-8 col-sm-12 col-xs-12 mytable">
                                  <table class="">
                                    <tbody>
                                      <tr>
                                        <th>Name:</th>
                                        <td><?php echo $prof['first_name']; ?> <?php echo $prof['last_name']; ?></td>
                                      </tr>
                                      <tr>
                                        <th>Email:</th>
                                      ...
                                      <tr>
                                        <th>City:</th>
                                        <td><?php echo $prof['city_name']; ?></td>
                                      </tr>

                                       <tr>
                                        <th>Area:</th>
                                        <td><?php echo $prof['area_name']; ?></td>
                                      </tr>
                            ...
                            <div class="col-sm-12 page-login">
                                ...
                                <div class="bottom-form">
                                  <a href="<?php echo base_url(); ?>editprofile" class="btn btn-default pull-right">Edit Profile</a>
                                </div>
                                </div>
                            </div>
                    </form>
