        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                   ...
                   <div class="col-md-6">
                       <a href="<?php echo base_url(); ?>admin/admin_users/add"><button type="button" class="btn bg-primary waves-effect pull-right">
                         ...
                         <table class="table table-bordered table-striped basic-example dataTable">
                           ...
                           <tbody>
                            ...
                            <tr>
                              <?php  
								      $pr_id = $user['admin_id'];
                                      $pr_id1 = sprintf("%02d", $pr_id);
									  ?>
                            <td>ADM<?php echo $pr_id1; ?></td>
                            <td><?php echo $user['admin_name']; ?> </td>
                            <td><?php echo $user['admin_email']; ?></td>
							<td><?php echo $user['admin_mobile']; ?></td>
                           <td><?php if($user['user_type']==1){ echo "Super Admin"; } else { echo "Admin User"; } ?></td>
                            <td>
                           
                            <a class="button button-small edit" title="Edit" href="<?php echo base_url(); ?>admin/admin_users/edit/<?php echo $user['admin_id']; ?>"><i class="fa fa-pencil"></i>  </a>
                            <a class="button button-small trash" title="delete" onClick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url(); ?>admin/admin_users/delete/<?php echo $user['admin_id']; ?>"><i class="fa fa-trash"></i></a>
                             </td>
                              </tr>
						<?php } ?>
                                </tbody>
