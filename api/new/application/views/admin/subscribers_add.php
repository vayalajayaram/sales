                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
										...
										<option value="<?php echo $subscription['title']; ?>"><?php echo $subscription['title']; ?></option>
										<?php } ?>
										</select>
                                    </div>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12">
                                     <div class="form-group">
                                        <label>Price</label>
									<input type="text" class="form-control" placeholder="Price" name="price"  required maxlength="100" value="" />
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
                                     <div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Start Date" name="start_date"  required id="datepicker" />
									...
									<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Expiry Date" name="expiry_date"  required   id="datepicker1" />
                                    </div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									 <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Payment Date" name="payment_date"  required  id="datepicker2" />
                                    </div>
									</div>
                                   ...
                                   <div style="text-align:center">
                                     <div class="form-group">
									 <input type="hidden" name="subscriber_func" value="add">
