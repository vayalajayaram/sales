            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                       <a href="<?php echo base_url(); ?>admin/sellers/addseller"><button type="button" class="btn bg-primary waves-effect pull-right">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         ...
                         <table class="table table-bordered table-striped basic-example dataTable">
                           ...
                           <tbody>
                            ...
                            <td>
                            <a class="button button-small view" title="view" href="<?php echo base_url(); ?>admin/sellers/view/<?php echo $seller['s_id']; ?>"><i class="fa fa-eye"></i></a>
                            <a class="button button-small edit" title="Edit" href="<?php echo base_url(); ?>admin/sellers/editseller/<?php echo $seller['s_id']; ?>"><i class="fa fa-pencil"></i>  </a>
                            <a class="button button-small trash" title="delete" onClick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url(); ?>admin/sellers/deleteseller/<?php echo $seller['s_id']; ?>"><i class="fa fa-trash"></i></a>
                             </td>
                              </tr>
						<?php } ?>
                                </tbody>
