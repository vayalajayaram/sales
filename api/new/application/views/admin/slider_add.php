                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Slider Name" name="name"  required maxlength="100" />
                                    </div>
									</div>
									...
									<div class="form-group">
                                        <label>Slider Name</label>
                                    	<input type="text" class="form-control" placeholder="Slider Link" name="link"   maxlength="100" />
                                    </div>
									</div>
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">		
                                   <div class="form-group">
                                    	...
                                    	<input type="file" class="form-control" name="image"  required />(Image Size Should be 600px*422px)
                                    </div>
								</div>	
								...
								<div class="col-md-6 col-sm-6 col-xs-12">	
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Slider Sort Order" name="sort_order" min="1" required>
                                    </div>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
									 ...
									 <input type="hidden" name="slider_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Slider</button>
									 </div>
