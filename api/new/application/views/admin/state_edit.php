                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="State Name" name="name"  required maxlength="100" value="<?php echo $state['state_name']; ?>" />
                                    </div>
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Sort Order" name="sort_order" min="1" required value="<?php echo $state['sort_order']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="1" <?php if($state['status']==1){ echo "selected"; } ?> >Enable</option>
                                            <option value="0" <?php if($state['status']==0){ echo "selected"; } ?> >Disabled</option>
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="state_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit State</button>
									 </div>
