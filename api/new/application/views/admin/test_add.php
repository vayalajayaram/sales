                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                        <label>Name</label>
                                    	<input type="text" class="form-control" placeholder="Name" name="name"  required maxlength="250" value="" />
                                    </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="test_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Testimonials</button>
									 </div>
