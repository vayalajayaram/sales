                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Media Name" name="name"  required maxlength="250" value="<?php echo $media['media_name']; ?>" />
                                    </div>
									 ...
									 <div class="form-group">
										...
										<textarea name="description" class="form-control" id="ckeditor" required><?php echo $media['description']; ?></textarea>
                                    </div>
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Media Sort Order" name="sort_order" min="1" required value="<?php echo $media['sort_order']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="1" <?php if($media['status']==1){ echo "selected"; } ?> >Enable</option>
                                            <option value="0" <?php if($media['status']==0){ echo "selected"; } ?> >Disabled</option>
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="media_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Media</button>
									 </div>
