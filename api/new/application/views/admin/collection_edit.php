                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                        <label>Name</label>
                                    	<input type="text" class="form-control" placeholder="Name" name="name"  required maxlength="100" value="<?php echo $brand['name']; ?>" />
                                    </div>
                                    									
									
                                   <div class="form-group">
                                        <label>Image</label>
                                    	<input type="file" class="form-control" name="image"   />(Image Size Should be 186px*140px)<br>
<img src="<?php echo base_url(); ?><?php echo $brand['image']; ?>" width="100">
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Sort Order" name="sort_order" min="1" required value="<?php echo $brand['sort_order']; ?>">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Url</label>
                                    	
										<input type="text" class="form-control"  placeholder="Url" name="url"  required value="<?php echo $brand['url']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
									 ...
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Collection</button>
									 </div>
