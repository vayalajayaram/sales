                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                        <label>Name</label>
                                    	<input type="text" class="form-control" placeholder="Name" name="name"  required maxlength="250" value="<?php echo $faq['name']; ?>" />
                                    </div>
									 ...
									 <div class="form-group">
										...
										<textarea name="description" class="form-control" required><?php echo $faq['description']; ?></textarea>
                                    </div>
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Faq Sort Order" name="sort_order" min="1" required value="<?php echo $faq['sort_order']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="0" <?php if($faq['status']==0){ echo "selected"; } ?> >Disabled</option>
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="test_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Testimonials</button>
									 </div>
