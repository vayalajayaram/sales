...
<?php } ?>
						...
						<form  method="post" enctype="multipart/form-data">
						 ...
						 <input type="text" class="form-control1" placeholder="Area Name" name="name"  required maxlength="100" />
			      ...
			      <input type="number" min="1" class="form-control1" placeholder="Sort Order" name="sort_order" required />   
                          ...
                          <option value="0" >Disabled</option>
										 ...
										 &nbsp; 
                          <button  class="btn bg-cyan waves-effect" type="submit">Add Area</button>
						  <input type="hidden" name="area_func" value="add">
                        ...
                        <div class="card">
                            <div class="body"><?php if (count($areas) > 0 && $areas != false) { ?>
                                <table class="table table-bordered table-striped table-hover basic-example" id="bootstrap-table">
									...
									<?php 
									  ...
									  ?>
                                    <tr>
									    <td data-field="name"><?php echo $area['area_name']; ?></td>
                                        <td data-field="name"><?php echo $area['city_name']; ?></td>
                                        
										
										<td data-field="name"><?php echo $area['sort_order']; ?></td>
										                                        
                                        <td data-field="status"><?php if($area['status']==1){ echo "Enable"; } else { echo "Disabled"; } ?></td>
                                        <td>
                                          <a href="<?php echo base_url(); ?>admin/area/editarea/<?php echo $area['a_id']; ?>"><button class="btn bg-cyan waves-effect" type="button">Edit</button></a>
										<a href="<?php echo base_url(); ?>admin/area/deletearea/<?php echo $area['a_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">  <button class="btn bg-red waves-effect" type="button">Delete</button></a> 
                                        </td>
                                    </tr>
									<?php  }  ?>
