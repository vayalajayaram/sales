                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         ...
                         <table class="table table-bordered table-striped basic-example dataTable">
                           ...
                           <tbody>
                            ...
                            <tr>
                            <td><?php echo $subscription['pkg_id']; ?></td>
                            <td><?php echo $subscription['title']; ?></td>
                            <td>Rs.<?php echo $subscription['price_m']; ?></td>
							<td></td>
                            <td><?php echo $subscription['status']; ?></td>
                            <td>
                           
                            <a class="button button-small edit" title="Edit" href="<?php echo base_url(); ?>/admin/subscriptions/edit/<?php echo $subscription['sc_id']; ?>"><i class="fa fa-pencil"></i>  </a>
