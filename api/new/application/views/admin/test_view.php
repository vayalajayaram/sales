...
<a href="<?php echo base_url(); ?>admin/testimonials/addtestimonials"><button class="btn bg-purple" type="button">Add Testimonials</button></a></div> 
						
                       
						
                        <div class="card">
                            <div class="body"><?php if (count($faqs) > 0 && $faqs != false) { ?>
                                <table class="table table-bordered table-striped table-hover basic-example" id="bootstrap-table">
									...
									<?php 
									  ...
									  ?>
                                    <tr>
									    <td data-field="name"><?php echo $faq['name']; ?></td>
                                        <td data-field="name"><?php echo $faq['description']; ?></td>
                                        
										
										<td data-field="name"><?php echo $faq['sort_order']; ?></td>
										                                        
                                        <td data-field="status"><?php if($faq['status']==1){ echo "Enable"; } else { echo "Disabled"; } ?></td>
                                        <td>
                                          <a href="<?php echo base_url(); ?>admin/testimonials/edittestimonials/<?php echo $faq['t_id']; ?>"><button class="btn bg-cyan waves-effect" type="button">Edit</button></a>
										<a href="<?php echo base_url(); ?>admin/testimonials/deletetestimonials/<?php echo $faq['t_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">  <button class="btn bg-red waves-effect" type="button">Delete</button></a> 
                                        </td>
                                    </tr>
									<?php  }  ?>
