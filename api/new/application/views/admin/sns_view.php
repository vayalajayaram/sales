        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="page-header">
                    <h2>Slide Down Notification List</h2>
                    <ol class="breadcrumb">
...
<?php } ?>
                        ...
                        <div class="card">
                            <div class="body"><?php if (count($snss) > 0 && $snss != false) { ?>
                                <table class="table table-bordered table-striped table-hover basic-example" id="bootstrap-table">
									...
									<?php 
									  ...
									  ?>
                                    <tr>
									    <td data-field="name"><?php echo $sns['name']; ?></td>
                                         <td data-field="name"><?php echo $sns['link']; ?></td>
                                        <td data-field="name"><img src="<?php echo base_url().$sns['image']; ?>"></td>
                                     
                                        <td>
                                          <a href="<?php echo base_url(); ?>admin/snotifications/edit/<?php echo $sns['s_id']; ?>"><button class="btn bg-cyan waves-effect" type="button">Edit</button></a>
