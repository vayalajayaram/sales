                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Brand Name" name="name"  required maxlength="100" value="<?php echo $brand['brand_name']; ?>" />
                                    </div>
                                    									
									
                                   <div class="form-group">
                                        <label>Brand Image</label>
                                    	<input type="file" class="form-control" name="image"   />(Image Size Should be 200px*100px)<br>
<img src="<?php echo base_url(); ?><?php echo $brand['brand_image']; ?>" width="100">
                                    </div>
									
									 <div class="form-group">
                                        <label>Sort Order</label>
                                    	
										<input type="number" class="form-control"  placeholder="Brand Sort Order" name="sort_order" min="1" required value="<?php echo $brand['sort_order']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="1" <?php if($brand['brand_status']==1){ echo "selected"; } ?> >Enable</option>
                                            <option value="0" <?php if($brand['brand_status']==0){ echo "selected"; } ?> >Disabled</option>
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="brand_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Brand</button>
									 </div>
