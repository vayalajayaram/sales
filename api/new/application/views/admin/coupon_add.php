                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">		
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Coupon Code" name="code"  required maxlength="100" />
                                    </div>
                                    </div>
									<div class="col-md-6 col-sm-6 col-xs-12">		
                                    <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Coupon Value" name="value"  required maxlength="100" />
                                    </div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">		
									 <div class="form-group">
										...
										<input type="text" class="form-control" id="date" placeholder="Coupon Expiry Date" name="expiry_date" required>
                                    </div>
									</div>
                                    ...
                                    <div class="form-group">
									 ...
									 <input type="hidden" name="coupon_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Coupon</button>
									 </div>
