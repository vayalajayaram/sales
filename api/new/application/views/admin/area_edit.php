                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Area Name" name="name"  required maxlength="100" value="<?php echo $area['area_name']; ?>" />
                                    </div>
                                    									
									<div class="form-group">
                                        <label>City Status</label>
                                        <select class="form-control" size="1" name="city" required>
                                            <option value="">Select City</option>
											 <?php foreach($cities as $city){  ?>
                          <option value="<?php echo $city['c_id']; ?>" <?php if($area['city_id']==$city['c_id']){ echo "selected"; } ?>><?php echo $city['city_name']; ?></option>
                         <?php } ?>
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Area Sort Order" name="sort_order" min="1" required value="<?php echo $area['sort_order']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="1" <?php if($area['status']==1){ echo "selected"; } ?> >Enable</option>
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="area_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Area</button>
									 </div>
