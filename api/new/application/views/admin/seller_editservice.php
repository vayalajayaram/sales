                                ...
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Product name" name="name"  required="required" maxlength="100" value="<?php echo $product['service_name']; ?>" />
                                    </div>
                                   ...
                                   <div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									 ...
									 <div class="form-group">
                                        <label>Price</label>
                                    	<input type="text" class="form-control" placeholder="Price" name="price" maxlength="10"  required value="<?php echo $product['price']; ?>" />
                                    </div>
									 ...
									 <div class="form-group">
                                        ...
                                        <label>Availability</label><br>
										 <label class="eagle-check custom-checkbox">
                                                    <input class="eagle-check-input" type="checkbox" name="sunday" value="1"  <?php if($product['sunday']=='1'){ echo "checked"; }; ?>>
                                                    <span class="eagle-check-indicator"></span>
                                                    <span class="eagle-check-description">Sunday</span>
                                                </label> &nbsp;
												 <label class="eagle-check custom-checkbox">
                                                    <input class="eagle-check-input" type="checkbox" name="monday" value="1"  <?php if($product['monday']=='1'){ echo "checked"; }; ?>>
                                                    <span class="eagle-check-indicator"></span>
                                                    <span class="eagle-check-description">Monday</span>
                                                </label>
												&nbsp;
												<label class="eagle-check custom-checkbox">
                                                    <input class="eagle-check-input" type="checkbox" name="tuesday" value="1"  <?php if($product['tuesday']=='1'){ echo "checked"; }; ?>>
                                                    <span class="eagle-check-indicator"></span>
                                                    <span class="eagle-check-description">Tuesday</span>
                                                </label>
												&nbsp;
												<label class="eagle-check custom-checkbox">
                                                    <input class="eagle-check-input" type="checkbox" name="wednesday" value="1"  <?php if($product['wednesday']=='1'){ echo "checked"; }; ?>>
                                                    <span class="eagle-check-indicator"></span>
                                                    <span class="eagle-check-description">Wednesday</span>
                                                </label>
												&nbsp;
												<label class="eagle-check custom-checkbox">
                                                    <input class="eagle-check-input" type="checkbox" name="thursday" value="1" <?php if($product['thursday']=='1'){ echo "checked"; }; ?>>
                                                    <span class="eagle-check-indicator"></span>
                                                    <span class="eagle-check-description">Thursday</span>
                                                </label>
												&nbsp;
												<label class="eagle-check custom-checkbox">
                                                    <input class="eagle-check-input" type="checkbox" name="friday" value="1"  <?php if($product['friday']=='1'){ echo "checked"; }; ?>>
                                                    <span class="eagle-check-indicator"></span>
                                                    <span class="eagle-check-description">Friday</span>
                                                </label>
												&nbsp;
												<label class="eagle-check custom-checkbox">
                                                    <input class="eagle-check-input" type="checkbox" name="saturday" value="1" <?php if($product['saturday']=='1'){ echo "checked"; }; ?>>
                                                    <span class="eagle-check-indicator"></span>
							...
							<img src="<?php echo base_url(); ?><?php echo $product['product_image']; ?>" width="100">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="file"  placeholder="Product Image" name="pimage[]"  /> <br>
                                         (Product Thumb Image Size Should be 650px*650px)<img src="<?php echo base_url(); ?>uploads/services/service_<?php echo $product['service_id']; ?>_0.jpg" width="100">
                                    </div>
                                       </div>
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                   <div class="form-group">
                                        ...
                                        <input type="file"  placeholder="Product Image" name="pimage[]"  /> <br>
                                         (Product Thumb Image Size Should be 650px*650px)<img src="<?php echo base_url(); ?>uploads/services/service_<?php echo $product['service_id']; ?>_1.jpg" width="100">
                                    </div>
                                       </div>
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                   <div class="form-group">
                                        ...
                                        <input type="file"  placeholder="Product Image" name="pimage[]"  /> <br>
                                         (Product Thumb Image Size Should be 650px*650px)<img src="<?php echo base_url(); ?>uploads/services/service_<?php echo $product['service_id']; ?>_2.jpg" width="100">
                                    </div>
                                       </div>
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                   <div class="form-group">
                                        ...
                                        <input type="file"  placeholder="Product Image" name="pimage[]"  /> <br>
                                         (Product Thumb Image Size Should be 650px*650px)<img src="<?php echo base_url(); ?>uploads/services/service_<?php echo $product['service_id']; ?>_3.jpg" width="100">
                                    </div>
                                       </div>
                                     <div class="form-group" style="text-align:center">
									 <input type="hidden" name="service_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Service</button>
									 </div>
