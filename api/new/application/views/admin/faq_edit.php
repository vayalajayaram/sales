                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Faq Name" name="name"  required maxlength="250" value="<?php echo $faq['faq_name']; ?>" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="faq_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Faq</button>
									 </div>
