                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
									 ...
									 <div class="form-group">
                                    	...
                                    	<textarea name="name" class="form-control" required=""><?php echo $page['name']; ?></textarea>
										
                                    </div>
									
									 <div class="form-group">
                                        <label>Tag</label><br>
                                    	<textarea name="tag" class="form-control" required=""><?php echo $page['tag']; ?></textarea>
									 ...
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Footer</button>
									 </div>
