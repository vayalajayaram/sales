                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Slider Name" name="name"  required maxlength="100" value="<?php echo $slider['name']; ?>" />
                                    </div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Slider Link" name="link"   value="<?php echo $slider['link']; ?>" />
                                    </div>
									</div>
                                   ...
                                   <div class="form-group">
                                    	...
                                    	<input type="file" class="form-control" name="image"   />(Image Size Should be 600px*442px)<br>
<img src="<?php echo base_url().$slider['image']; ?>" width="100">
                                    </div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Slider Sort Order" name="sort_order" min="1" required value="<?php echo $slider['sort_order']; ?>">
                                    </div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="1" <?php if($slider['status']==1){ echo "selected"; } ?> >Enable</option>
									 ...
									 <input type="hidden" name="slider_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Slider</button>
									 </div>
