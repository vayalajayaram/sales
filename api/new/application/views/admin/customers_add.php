                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Customer Id" name="customer_id"  required maxlength="100" />
                                    </div>
									</div>
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                   ...
                                   <div style="text-align:center">
                                     <div class="form-group">
									 <input type="hidden" name="customer_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Customer</button>
