        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="page-header">
                    <h2>Edit Category Slider</h2>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url(); ?>admin/dashboard">Home</a></li>
						<li><a href="<?php echo base_url(); ?>admin/categories">Category</a></li>
						<li><a href="<?php echo base_url(); ?>admin/catslides/view/<?php echo $pimage['category_id']; ?>">Category Slider</a></li>
                        <li class="active">Edit Category Slider</li>
                    </ol>
                </div>
                <div class="row">
                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Title" name="title"  required value="<?php echo $pimage['title']; ?>" maxlength="100" />
                                    </div>
                                     <div class="form-group">
                                        <label>Link</label>
                                    	<input type="text" class="form-control" placeholder="Link" name="text"   value="<?php echo $pimage['link']; ?>" maxlength="100" />
                                    </div>
                                    
									  
                                   <div class="form-group">
                                        <label>Sort Order</label>
                                    	<input type="number" class="form-control" placeholder="Sort Order" name="sort_order"  required value="<?php echo $pimage['sort_order']; ?>" min="1" />
                                    </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input type="hidden" name="cid" value="<?php echo $pimage['category_id']; ?>">
