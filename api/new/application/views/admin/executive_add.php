                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">	  
                                   <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Phone Number" name="phone"  required  maxlength="10" pattern="[0-9]{10}"/>
                                    </div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Alternate Phone" name="altphone"  required maxlength="10" pattern="[0-9]{10}" />
                                    </div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Executive Code" name="code" required />
                                    </div>
									</div>
                                    ...
                                    <div class="form-group">
									 ...
									 <input type="hidden" name="executive_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Executive</button>
									 </div>
