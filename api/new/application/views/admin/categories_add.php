                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="file"  placeholder="Category Image" name="image" required /> 
                                         (Image size should be 22px X 22px)
                                    </div>
                                    
                                      <div class="form-group">
                                        <label>Category Banner</label>
                                        <input type="file"  placeholder="Banner Image" name="pimage[]" required /> 
                                        (Banner size should be 1200px X 111px)
                                    </div>
                                          
                                     <div class="form-group">
									 <input type="hidden" name="category_func" value="add">
