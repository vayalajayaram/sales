                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Address Title" name="title"  required  maxlength="100" />
                                    </div>
									</div>
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                   ...
                                   <div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									 ...
									 <button class="btn bg-cyan waves-effect" type="submit">Add Address</button>
									 </div>
									
                                    <input type="hidden" name="uid" value="<?php echo $uid; ?>">
									<input type="hidden" name="address_func" value="add">
                                </form>
                            </div>
