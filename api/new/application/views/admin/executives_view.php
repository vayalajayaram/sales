...
<?php } ?>
                        <div class="card" style="background:none;box-shadow:none;margin-bottom:5px; text-align:right; min-height:20px;">
                           <a href="<?php echo base_url(); ?>admin/executives/addexecutive"><button class="btn bg-purple" type="button">Add Executive</button></a>
                        </div>
						
                        <div class="card">
                            <div class="body"><?php if (count($executives) > 0 && $executives != false) { ?>
                                <table class="table table-bordered table-striped table-hover basic-example" id="bootstrap-table">
									...
									<?php 
									  ...
									  ?>
                                    <tr>
									    <td data-field="name"><?php echo $executive['first_name']; ?></td>
                                        
                                        <td data-field="sname">
										<?php echo $executive['last_name']; ?>
										</td>
										
										<td data-field="name"><?php echo $executive['phone']; ?></td>
										<td data-field="name"><?php echo $executive['email']; ?></td>
										                                        
                                        <td data-field="status"><?php if($executive['status']==1){ echo "Enable"; } else { echo "Disabled"; } ?></td>
                                        <td>
                                          <a href="<?php echo base_url(); ?>admin/executives/editexecutive/<?php echo $executive['e_id']; ?>"><button class="btn bg-cyan waves-effect" type="button">Edit</button></a>
										<a href="<?php echo base_url(); ?>admin/executives/deleteexecutive/<?php echo $executive['e_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">  <button class="btn bg-red waves-effect" type="button">Delete</button></a> 
                                        </td>
                                    </tr>
									<?php  }  ?>
