                                ...
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Product name" name="name"  required="required" maxlength="100" />
                                    </div>
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div class="form-group">
                                    	...
                                    	<select name="brand" class="form-control" required >
                                    		...
                                    		<option value="<?php echo $brand['b_id']; ?>"><?php echo $brand['brand_name']; ?></option>
                                    		<?php } ?>
                                   		</select>
                                    </div>
									</div>
                                   ...
                                   <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Item Code" name="item" maxlength="15" required />
                                    </div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">								
									 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Total Stock" name="stock"  required  />
                                    </div>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12">
									 <div class="form-group">
                                        <label>Availability</label><br>
                                    	<label class="radio-inline"><input type="radio" name="available" value="in_stock" required>In Stock</label>
<label class="radio-inline"><input type="radio" name="available" value="out_of_stock" required>Out Of Stock</label>
								  ...
								  <div class="col-md-6 col-sm-6 col-xs-12">
									 <div class="form-group">
                                    	...
                                    	<label class="radio-inline"><input type="radio" name="free_bee" value="1" required >Yes</label>
<label class="radio-inline"><input type="radio" name="free_bee" value="0" required >No</label>
...
<label class="radio-inline"><input type="radio" name="display_home" value="0" required >No</label>
								  ...
								  <div class="col-md-12 col-sm-12 col-xs-12">								
									 <div class="form-group">
										...
										<option value="<?php echo $weight['w_id']; ?>"><?php echo $weight['weight']; ?></option>
										<?php } ?>
										</select>
                                    </div>
									</div>
									...
									<div class="col-md-12 col-sm-6 col-xs-12">
									 <div class="form-group">
                                        <label>Cooking Tips</label>
                                    	 <textarea id="editor1" name="cooking_tips"></textarea>
								  ...
								  <div class="col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <div class="form-group">
									...
									<div class="col-md-12 col-sm-6 col-xs-12">
									 ...
									 <input type="hidden" name="product_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Product</button>
									 </div>
