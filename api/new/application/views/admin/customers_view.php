            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                       <a href="<?php echo base_url(); ?>admin/customers/addcustomer"><button type="button" class="btn bg-primary waves-effect pull-right"><i class="fa fa-plus"></i> Add Customer</button></a>
                     </div>
                </div>
                <!-- Default Tab -->
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         ...
                         <table class="table table-bordered table-striped basic-example dataTable">
                           ...
                           <tbody>
                            ...
                            <td>
                            <a class="button button-small view" title="view" href="<?php echo base_url(); ?>admin/customers/view/<?php echo $customer['c_id']; ?>"><i class="fa fa-eye"></i></a>
                            <a class="button button-small edit" title="Edit" href="<?php echo base_url(); ?>admin/customers/editcustomer/<?php echo $customer['c_id']; ?>"><i class="fa fa-pencil"></i>  </a>
                            <a class="button button-small trash" title="delete" onClick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url(); ?>admin/customers/deletecustomer/<?php echo $customer['c_id']; ?>"><i class="fa fa-trash"></i></a>
                             </td>
                              </tr>
						<?php } ?>
                                </tbody>
