        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="page-header">
                    <h2>Edit <?php echo $page['page_name']; ?></h2>
                    <ol class="breadcrumb">
                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Meta Title" name="meta_title"   maxlength="100" value="<?php echo $page['meta_title']; ?>" />
                                    </div>                                     
									
									 <div class="form-group">
                                        <label>Meta Keywords</label><br>

                                    	<textarea name="meta_keywords" class="form-control"><?php echo $page['meta_keywords']; ?></textarea>
										
                                    </div>
									
									 <div class="form-group">
                                        <label>Meta Description</label><br>
                                    	<textarea name="meta_description" class="form-control"><?php echo $page['meta_description']; ?></textarea>
										
                                    </div>
									
									 <div class="form-group">
                                        <label>Description</label><br>
                                    	<textarea name="description" id="ckeditor"><?php echo $page['description']; ?></textarea>
										
                                    </div>	                                   
                                          
                                     <div class="form-group">
									 <input type="hidden" name="page_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Page</button>
									 </div>
