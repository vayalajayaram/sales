                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Media Name" name="name"  required maxlength="250" value="" />
                                    </div>
                                    		
								<div class="form-group">
                                        <label>Media Description</label>
                                    	
										<textarea class="form-control" id="ckeditor" name="description" required></textarea>
                                    </div>									
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Sort Order" name="sort_order" min="1" required value="">
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="media_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Media</button>
									 </div>
