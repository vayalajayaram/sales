                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                        <label> Name</label>
                                    	<input type="text" class="form-control" placeholder=" Name" name="name"  required maxlength="250" value="<?php echo $review['name']; ?>" />
                                    </div>
									 ...
									 <div class="form-group">
										...
										<textarea name="description" class="form-control" required><?php echo $review['description']; ?></textarea>
                                    </div>
								    ...
								    <div class="form-group">
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Media Sort Order" name="sort_order" min="1" required value="<?php echo $review['sort_order']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="1" <?php if($review['status']==1){ echo "selected"; } ?> >Enable</option>
                                            <option value="0" <?php if($review['status']==0){ echo "selected"; } ?> >Disabled</option>
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="review_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Review</button>
									 </div>
