...
<a href="<?php echo base_url(); ?>admin/faqs/addfaq"><button class="btn bg-purple" type="button">Add Faq</button></a></div> 
                            ...
                            <div class="body"><?php if (count($faqs) > 0 && $faqs != false) { ?>
                                <table class="table table-bordered table-striped table-hover basic-example" id="bootstrap-table">
									...
									<?php 
									  ...
									  ?>
                                    <tr>
									    <td data-field="name"><?php echo $faq['faq_name']; ?></td>
                                        ...
                                        <td>
                                          <a href="<?php echo base_url(); ?>admin/faqs/editfaq/<?php echo $faq['f_id']; ?>"><button class="btn bg-cyan waves-effect" type="button">Edit</button></a>
										<a href="<?php echo base_url(); ?>admin/faqs/deletefaq/<?php echo $faq['f_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">  <button class="btn bg-red waves-effect" type="button">Delete</button></a> 
                                        </td>
                                    </tr>
									<?php  }  ?>
