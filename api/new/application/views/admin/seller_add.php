                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Company Name" name="company"  required maxlength="100" />
                                    </div>
									</div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                        <label>Seller Credits</label>
                                    	<input type="text" class="form-control" placeholder="Seller Credits" name="credits"  required  />
                                    </div>
									</div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
									 <div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="First name" name="fname"  required maxlength="100" />
                                    </div>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12">
                                     <div class="form-group">
                                        <label>Last Name</label>
                                    	<input type="text" class="form-control" placeholder="Last name" name="lname" maxlength="100" required />
                                    </div>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12">
                                     <div class="form-group">
								 ...
								 <div class="form-group">
                                   ...
                                   <div style="text-align:center">
                                     <div class="form-group">
									 <input type="hidden" name="seller_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Seller</button>
