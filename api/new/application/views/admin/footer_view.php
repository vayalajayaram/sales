                            ...
                            <div class="body"><?php if (count($pages) > 0 && $pages != false) { ?>
                                <table class="table table-bordered table-striped table-hover basic-example" id="bootstrap-table">
									...
									<?php 
									  ...
									  ?>
                                    <tr>
									    <td data-field="name"><?php echo $page['name']; ?></td>
                                        <td data-field="name"><?php echo $page['tag']; ?></td>
                                     
                                        <td>
                                          <a href="<?php echo base_url(); ?>admin/footer/edit/<?php echo $page['f_id']; ?>"><button class="btn bg-cyan waves-effect" type="button">Edit</button></a>
