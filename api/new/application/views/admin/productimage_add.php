                ...
                <div class="page-header">
                    ...
                    <ol class="breadcrumb">
                       <li><a href="<?php echo base_url(); ?>admin/dashboard">Home</a></li>
                        ...
                        <li><a href="<?php echo base_url(); ?>admin/pimages/view/<?php echo $pid; ?>">Product Images</a></li>
                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Image Title" name="title"  required maxlength="100" />
                                    </div>
                                     <div class="form-group">
                                        <label>Alternate Text</label>
                                    	<input type="text" class="form-control" placeholder="Alternate Text" name="text"  required maxlength="100" />
                                    </div>
                                    
									  
                                   <div class="form-group">
                                        <label>Sort Order</label>
                                    	<input type="number" class="form-control" placeholder="Sort Order" name="sort"  required min="1" />
                                    </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="file"  placeholder="Product Image" name="image" required /> 
                                    </div>
									 ...
									 <button class="btn bg-cyan waves-effect" type="submit">Add Product Image</button>
									 </div>
                                    <input type="hidden" name="pid" value="<?php echo $pid; ?>">
									<input type="hidden" name="image_func" value="add">
                                </form>
                            </div>
                        </div>
                    </div>
