...
<?php } ?>
						...
						<form  method="post" enctype="multipart/form-data">
						 ...
						 <input type="text" class="form-control1" placeholder="City Name" name="name"  required maxlength="100" />
						 
						    <input type="number" min="1" class="form-control1" placeholder="Sort Order" name="sort_order"  required  />   <select class="form-control1" name="status" required>  
										 ...
										 &nbsp; 
                          <button  class="btn bg-cyan waves-effect" type="submit">Add City</button>
						  <input type="hidden" name="city_func" value="add">
                        ...
                        <div class="card">
                            <div class="body"><?php if (count($cities) > 0 && $cities != false) { ?>
                                <table class="table table-bordered table-striped table-hover basic-example" id="bootstrap-table">
									...
									<?php 
									  ...
									  ?>
                                    <tr>
									    <td data-field="name"><?php echo $city['city_name']; ?></td>
                                                                               
										
										<td data-field="name"><?php echo $city['sort_order']; ?></td>
										                                        
                                        <td data-field="status"><?php if($city['status']==1){ echo "Active"; } else { echo "Inactive"; } ?></td>
                                        <td>
                                          <a href="<?php echo base_url(); ?>admin/city/editcity/<?php echo $city['c_id']; ?>"><button class="btn bg-cyan waves-effect" type="button">Edit</button></a>
										<a href="<?php echo base_url(); ?>admin/city/deletecity/<?php echo $city['c_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">  <button class="btn bg-red waves-effect" type="button">Delete</button></a> 
                                        </td>
                                    </tr>
									<?php  }  ?>
