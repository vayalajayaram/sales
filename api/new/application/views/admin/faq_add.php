                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Faq Name" name="name"  required maxlength="250" value="" />
                                    </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="faq_func" value="add">
									 <button class="btn bg-cyan waves-effect" type="submit">Add Faq</button>
									 </div>
