                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                        <label>Weight</label>
                                    	<input type="text" class="form-control" placeholder="Weight" name="name"  required maxlength="100" value="<?php echo $weight['weight']; ?>" />
                                    </div>
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="Sort Order" name="sort_order" min="1" required value="<?php echo $weight['sort_order']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="1" <?php if($weight['status']==1){ echo "selected"; } ?> >Enable</option>
                                            <option value="0" <?php if($weight['status']==0){ echo "selected"; } ?> >Disabled</option>
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="weight_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Weight</button>
									 </div>
