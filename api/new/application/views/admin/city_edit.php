                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
								 ...
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="City Name" name="name"  required maxlength="100" value="<?php echo $brand['city_name']; ?>" />
                                    </div>
									 ...
									 <div class="form-group">
										...
										<input type="number" class="form-control"  placeholder="City Sort Order" name="sort_order" min="1" required value="<?php echo $brand['sort_order']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
									 ...
									 <button class="btn bg-cyan waves-effect" type="submit">Edit City</button>
									 </div>
