                            ...
                            <div class="body">
                                <form  method="post" enctype="multipart/form-data">
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Sub Category name" name="name"  required value="<?php echo $subcategory['subcategory_name']; ?>" />
                                    </div>
                                    <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Sort Order" name="sort_order" value="<?php echo $subcategory['sort_order']; ?>" required min="1" />
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
                                     ...
                                     <div class="form-group">
									 <input type="hidden" name="subcategory_func" value="edit">
