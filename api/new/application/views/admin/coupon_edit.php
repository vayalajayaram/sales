                            ...
                            <div class="body">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">		
								 <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Coupon Code" name="code"  required value="<?php echo $coupon['coupon_code']; ?>" maxlength="100" />
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    	...
                                    	<select name="type" class="form-control" required >
											...
											<option value="1" <?php if($coupon['coupon_type']==1){ echo "selected"; } ?>>Amount</option>
											<option value="0" <?php if($coupon['coupon_type']==0){ echo "selected"; } ?>>%</option>
                                   ...
                                   <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Coupon Value" name="value"  required value="<?php echo $coupon['coupon_value']; ?>" maxlength="100" />
                                    </div>
									</div>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">		
									 <div class="form-group">
										...
										<input type="text" class="form-control" id="date" placeholder="Coupon Expiry Date" name="expiry_date" required value="<?php echo $coupon['coupon_expiry_date']; ?>">
                                    </div>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12">		
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" size="1" name="status" required>
                                            ...
                                            <option value="1" <?php if($coupon['coupon_status']==1){ echo "selected"; } ?>>Enable</option>
                                            <option value="0" <?php if($coupon['coupon_status']==0){ echo "selected"; } ?>>Disabled</option>
									 ...
									 <input type="hidden" name="coupon_func" value="edit">
									 <button class="btn bg-cyan waves-effect" type="submit">Edit Coupon</button>
									 </div>
