               ...
               <div class="col-sm-9 col-md-9 col-xs-12 myenquires">
                  <table class="table-bordered table-condensed">
                    <tbody>
                      ...
                      <tr>
                        <th>Name</th>
                        <td><?php echo $quotationpdetails['first_name']; ?> <?php echo $quotationpdetails['last_name']; ?></td>
                      </tr>
                      <tr>
                        <th>Email</th>
                        <td> <?php echo $quotationpdetails['email']; ?></td>
                      </tr>
                      <tr>
                        <th>Phone no</th>
                        <td><?php echo $quotationpdetails['phone']; ?></td>
                      </tr>

                      <tr>
                        <th>Product Name</th>
                        <td><?php echo $quotationpdetails['product_name']; ?></td>
                      </tr>
...
-->
                      <tr>
                          ...
                          <td>
                            <table class="table-responsive">
                              ...
                              <tr>
                                <th>Address</th>
                                <td><?php echo $quotationpdetails['address1']; ?> <?php echo $quotationpdetails['address2']; ?>,<?php echo $quotationpdetails['area_name']; ?>,<?php echo $quotationpdetails['city_name']; ?></td>
                              </tr>
                      ...
                      <tr>
                        <th>Description</th>
                        <td><?php echo $quotationpdetails['message']; ?> </td>
                      </tr>
                      
                      <tr>
                        <th>View Product </th>
                        <td><a href="<?php echo base_url(); ?>details/<?php echo str_replace(" ","-",$quotationpdetails['product_name']); ?>/<?php echo $quotationpdetails['product_id']; ?>" target="_blank">View Product Details</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
