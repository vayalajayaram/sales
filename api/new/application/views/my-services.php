                ...
                <div class="col-sm-12">
                  <div class="row">
                    <div class="bottom-form pull-right">
                      <a href="<?php echo base_url(); ?>addservice" class="btn btn-primary"><i class="fa fa-plus-circle"></i> ADD NEW</a>
                    </div>
                  </div>
                </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="product-thumb">
                            <img width="80px" height="auto" src="<?php echo base_url().$prod['product_image']; ?>" alt="<?php echo $prod['service_name']; ?>">
                          </td>
                          <td class="product-details">
                            <h3 class="title"><?php echo $prod['service_name']; ?></h3>
                            
                            <span class="status active"><strong>Status : </strong><?php if($prod['status']==1){ echo "Active"; } else { echo "Inactive"; }; ?></span>
                          </td>
                          <td class="myprice"><span><i class="fa fa-inr"></i> <?php echo $prod['price']; ?></span></td>
                            ...
                            <div class="">
                              <ul class="list-inline justify-content-center">
                               ...
                               <li class="list-inline-item">
                                  <a href="<?php echo base_url(); ?>editservice/<?php echo $prod['service_id']; ?>" class="edit"  data-toggle="tooltip" data-placement="top" title="edit">
                                    <i class="fa fa-pencil"></i>
                                  </a>    
                                </li>
                                <li class="list-inline-item">
                                  <a href="<?php echo base_url(); ?>dashboard/deleteservice/<?php echo $prod['service_id']; ?>" class="delete"  onclick="return confirm('Are you sure you want to delete this item?');">
