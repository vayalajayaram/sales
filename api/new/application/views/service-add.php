                    ...
                    <div class="row">
                        ...
                        <div class="table_cell">
                         <fieldset>
                            ...
                            <ul class="checkboxes_list list-inline list-unstyled">
                               <li>
                                  <input type="checkbox" checked="" name="sun" id="category_1" value="1">
                                  <label for="category_1">Sun</label>
                               </li>
                               <li>
                                  <input type="checkbox" name="mon" id="category_2" value="1">
                                  <label for="category_2">Mon</label>
                               </li>
                               <li>
                                  <input type="checkbox" name="tue" id="category_3" value="1">
                                  <label for="category_3">Tue</label>
                               </li>
                               <li>
                                  <input type="checkbox" name="wed" id="category_4" value="1">
                                  <label for="category_4">Wed</label>
                               </li>
                               <li>
                                  <input type="checkbox" name="thu" id="category_5" value="1">
                                  <label for="category_5">Thu</label>
                               </li>
                               <li>
                                  <input type="checkbox" name="fri" id="category_6" value="1">
                                  <label for="category_6">Fri</label>
                               </li>
                               <li>
                                  <input type="checkbox" name="sat" id="category_7" value="1">
                      ...
                      <div class="col-sm-12">
                         <div class="form-group">
                           ...
                           <textarea name="description" id="ckeditor" rows="10" class="form-control" required></textarea>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="btn-group btn-group-horizontal" data-toggle="buttons">
                          <label class="btn active">
                            <input type="radio" name="feature" checked="" value="1"><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span> Yes</span>
                          </label>
                          <label class="btn">
                            <input type="radio" name="feature" value="0"><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> No</span>
                          </label>
                        </div>
                      </div>
