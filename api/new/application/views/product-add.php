                      ...
                      <div class="col-xs-12 col-sm-6 col-md-6 radio1">
                        ...
                        <div class="btn-group btn-group-horizontal" data-toggle="buttons">
                          <label class="btn active">
                            <input type="radio" name="available" checked="" value="in_stock"><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span> In Stock</span>
                          </label>
                          <label class="btn">
                            <input type="radio" name="available" value="out_of_stock"><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> Out Stock</span>
                          </label>
                        </div>
                      </div>
