                            ...
                            <div class="clear">
                              <div class="col-sm-6 padding-top-25">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Mobile Number" name="mobile" required maxlength="10">
                                    </div>
                                    <div class="form-group">
                                        <label>Enter Password <small>(required)</small></label>
                                ...
                                <div class="col-sm-6 myclip">
                                  <img src="<?php echo base_url(); ?>image/laptop-guy.png" class="img-responsive">
                                </div>
                            </div>
