      ...
      <?php include('header.php') ?>
         ...
         <div class="main-container container">
            ...
            <div class="row">
               ...
               <div class="col-sm-12 col-md-8 col-md-offset-2 col-xs-12  profiel-container">
                    <form action="" method="post" class="profiel-container1 clearfix">
                            ...
                            <div class="clear">
                              ...
                              <div class="col-sm-6 padding-top-25">
                                ...
                                <p>Please provide the username or email address that you used when you signed up for your Evernote account.</p>

                                <p>We will send you an email that will allow you to reset your password.</p>
                                <hr>

                                    <div class="form-group">
                                        <label>Email address or username<small>(required)</small></label>
                                        <input name="email" type="email" class="form-control" required value="<?php echo $this->session->flashdata('email'); ?>">
                                    </div> 
                                    <div style="color:#F00;"><?php echo $this->session->flashdata('error'); ?></div>
                                </div>

                                <div class="col-sm-6 myclip">
                                  <img src="<?php echo base_url(); ?>image/laptop-guy.png" class="img-responsive" alt="add">
                                </div>
                            ...
                            <div class="col-sm-12 page-login">
                                ...
                                <div class="bottom-form">
                                  <button type="submit" class="btn btn-default pull-right">Send verification email</button>
                                </div>
                                </div>
                            </div>
