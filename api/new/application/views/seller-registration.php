                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                              <div class="form-group">
                                <label class="control-label " for="input-email"> Password</label>
                                 <input type="password" class="form-control" placeholder="Password" name="password"  required maxlength="20"  onchange="if(this.checkValidity()) form.cpassword.pattern = this.value;"  value="<?php echo $_SESSION['sfdata']['password']; ?>" />
                              </div>
                             </div>
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <input type="password" class="form-control" placeholder="Confirm Password" name="cpassword"  required maxlength="20" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Please enter the same Password as above' : '');" value="<?php echo $_SESSION['sfdata']['cpassword']; ?>" />
                              </div>
                           </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <div class="form-group">
