                ...
                <div class="col-md-12">
                  <div class="panel-group accordion-faq" id="faq-accordion">
                    <div class="panel">
					  ...
					  <form action="<?php echo base_url(); ?>register/bseller_first" method="post">
                        <div class="panel-body">
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" readonly pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="<?php echo $_SESSION['sfdata']['email']; ?>" />
                              </div>     
                              </div>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                              <div class="form-group">
                                <label class="control-label" for="input-email"> Phone Number</label>
                                <input type="text" name="phone"  class="form-control" readonly value="<?php echo $_SESSION['sfdata']['phone']; ?>" />
                              </div>
                              </div>
                               <div class="col-md-6 col-sm-6 col-xs-12">                     
                              <div class="form-group">
                    ...
                    <div class="panel">
					  ...
					  <form action="<?php echo base_url(); ?>register/bseller_second" method="post">
                        <div class="panel-body">
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              <div class="form-group">
                              ...
                              <table class="table1 table-responsive">
                                  ...
                                  <tfoot>
                                      <tr>
                                          ...
                                          <td>
										  <form action="<?php echo base_url(); ?>register/bsellerfinal" method="post" id="sub1">
                                            <div class="form-group">
										...
										<input name="mprice" value="<?php echo $subscription2['price_m']; ?>" type="hidden" id="mpr1">
                                         <input name="credits" value="<?php echo $subscription2['credits']; ?>" type="hidden" >
                                          ...
                                          <td>
									<form action="<?php echo base_url(); ?>register/bsellerfinal" method="post" id="sub3">
                                           <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <!-- <div class="radio1 clearfix brdr-btn">
                             ...
                             <div class="proceed_pay">
                              <a href="<?php echo base_url(); ?>register/bsellersubmit" class="btn btn-primary">Proceed to pay</a>
                            </div>
