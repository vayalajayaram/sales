                  ...
                  <div class="table-responsive myenquires">
                    <table class="table-bordered table-condensed">
                      <tbody>
                        ...
                        <tr>
                          <th>Service Name</th>
                          <td><?php echo $penqdetails['service_name']; ?></td>
                        </tr>
						
						  <tr>
                          <th>Appointment</th>
                          <td><?php echo $penqdetails['appointment']; ?></td>
                        </tr>
                        ...
                        <tr>
                          <th>View Service </th>
                          <td><a href="<?php echo base_url(); ?>sdetails/<?php echo str_replace(" ","-",$penqdetails['service_name']); ?>/<?php echo $penqdetails['service_id']; ?>" target="_blank">View Service Details</a></td>
                        </tr>
                      </tbody>
                    </table> 
                  </div>
