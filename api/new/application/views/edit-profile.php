         ...
         <div class="main-container container">
            ...
            <div class="row">
               ...
               <div class="col-sm-9 col-md-9 col-xs-12  profiel-container">
                    <form action="" method="post" class="profiel-container1 clearfix" enctype="multipart/form-data">
                            ...
                            <div class="clear">
                                <div class="col-sm-12 col-md-4">
                                    <div class="picture-container">
                                        <div class="picture">
                                    <img src="<?php echo base_url().$prof['image']; ?>" class="picture-src img-circle" id="wizardPicturePreview" name="" alt="team">
                                ...
                                <div class="col-sm-6 col-md-4 padding-top-25">
                                    <div class="form-group">
                                        <label>First Name <small>(required)</small></label>
                                        <input name="first_name" type="text" class="form-control" value="<?php echo $prof['first_name']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4 padding-top-25">
                                    <div class="form-group">
                                        ...
                                        <input name="last_name" type="text" class="form-control" value="<?php echo $prof['last_name']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="email" type="email" class="form-control" value="<?php echo $prof['email']; ?>" required>
                                    </div> 
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="phone" type="text" class="form-control" value="<?php echo $prof['phone']; ?>" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="city" class="form-control" required id="city">
                                          <option value="">Please select</option>
                                            ...
                                            <option value="<?php echo $city['c_id']; ?>" <?php if($city['c_id']==$prof['city']){ echo "selected"; } ?> ><?php echo $city['city_name']; ?></option>
                                            <?php } ?>    
                                        </select>
...
$("select[name='city']").change(function(){
      var cid = $(this).val();
      var aid=<?php echo $prof['area'] ?>;
      $.ajax({
          url: "<?php echo base_url();?>dashboard/ajax_city1",
          method: 'POST',
