		...
		<div class="ciuis-body-content">
			<div class="col-md-4 login-left">
				<div class="lg-content">
					<h2>LEAD CRM</h2>
					<p class="text-muted">LEAD CRM software for customer relationship management is available for sale, so you can get more information to take advantage of your exclusive concierge.</p>
					<a href="http://www.nexivo.co/" class="btn btn-warning p-l-20 p-r-20"><?php echo lang('loginhelpbutton')?></a>
				</div>
			</div>
			<div style="float: right; margin-top: 5%;" class="main-content container-fluid col-md-8">
				<div class="splash-container">
					<div class="panel panel-default">
						<div class="panel-heading"><img src="<?php echo base_url('assets/img/logo-fav.png'); ?>" alt="logo" class="logo-img">LEAD CRM<span class="splash-description"><?php echo lang('logindescription')?></span>
						</div>
